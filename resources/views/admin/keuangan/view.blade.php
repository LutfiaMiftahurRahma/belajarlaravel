				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h4>
								Tanggungan Keuangan {{ $th_lulus }}
								<a style="float: right; margin-left: 10px" href="{{route('import.keu', $th_lulus)}}" class="btn btn-xs btn-success">
									Import Tanggungan
								</a>
							</h4>
						</div><!-- /.page-header -->
									...
									<table id="example1" class="table  table-bordered table-hover">
										...
										<tbody>
										    ...
										    <tr>
												...
												<td>
													<div class="btn-group">
														<a href="{{route('edit.keu',[$th_lulus, $row->s_id])}}" class="btn btn-xs btn-success">
