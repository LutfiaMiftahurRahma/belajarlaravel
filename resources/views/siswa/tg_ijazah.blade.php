									...
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-3 center">
											...
											<div class=" infobox-container">
												...
												<div class="">
													<textarea rows="6" cols="35" readonly="true">Mohon Maaf, ijazah  belum dapat diambil karena blanko ijazah atas nama Anda belum datang dari pusat. Informasi lebih lanjut silahkan menghubungi Ust. Sujari (+62 852-3070-9247). Sekian terima kasih.</textarea>
												</div>

												<div class="hr hr16 dotted"></div> 

											</div> 
											@elseif($row->ketuntasan=="TUNTAS")    
											<div class=" infobox-container">
												<div class="infobox infobox-green">
													...
													<div class="infobox-data">
														...
														<div class="infobox-content">{{$row->ketuntasan}}</div>
													</div>
												</div>
										...
										<div class="col-xs-12 col-sm-9">
											...
											@if($row->status_ijazah=="DITANGGUHKAN" or $row->ketuntasan=="TUNTAS")
											@else
												...
												{{ csrf_field() }}
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input type="text" id="nominal" name="nominal" value="@currency($row->nominal)" readonly="true" class="col-xs-10 col-sm-5" readonly="true" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input type="text" id="denda_perpus" name="denda_perpus" value="@currency($row->denda_perpus)" readonly="true" class="col-xs-10 col-sm-5" readonly="true" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" id="nominal_aman_pa" name="nominal_aman_pa" value="@currency($row->nominal_aman_pa)" readonly="true" class="col-xs-10 col-sm-5" readonly="true" />
															</div>
														</div>
													...
													@elseif($row->bukti_pondok!=NULL)
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" id="nominal_pondok" name="nominal_pondok" value="@currency($row->nominal_pondok)" readonly="true" class="col-xs-10 col-sm-5" readonly="true" />
															</div>
														</div>
														@endif
														<div class="form-group">
