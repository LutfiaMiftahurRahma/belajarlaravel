...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Tanggungan Pondok</title>

		<meta name="description" content="" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />

		@include('pondok/loadcss')
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="{{route('pondokhome')}}">Home</a>
							</li>
						</ul><!-- /.breadcrumb -->
					</div>
												...
												<div class="table-detail">
													<div class="row">
														<div class="col-xs-12 col-sm-3">
															...
															<form action="{{route('ijazah.pondok', [$th_lulus, $row->s_id])}}" method="post">
											              		{{ csrf_field() }}
																<!-- pondok putra -->
																<div class="form-group">
																	<label for="tg_pondok">Tanggungan Pondok Putra</label>
																...
																<div class="form-group">
																	<label for="ket_pondok"> Keterangan Pondok Putra</label>
